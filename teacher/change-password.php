...
if (strlen($_SESSION['sturecmsstuid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT StuID FROM tblteacher WHERE StuID=:sid and Password=:cpassword";
    ...
    if ($query->rowCount() > 0) {
      $con = "update tblteacher set Password=:newpassword where StuID=:sid";
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" name="changepassword" method="post" onsubmit="return checkpass();">
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword4">Ulangi Password</label>
