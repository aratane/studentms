        ...
        <div class="row flex-grow">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <h6 class="font-weight-light">Masukkan alamat email dan nomor ponsel Anda untuk mengatur ulang kata sandi!</h6>
              <form class="pt-3" id="login" method="post" name="login">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control form-control-lg" name="mobile" placeholder="Nomor Telepon" required="true" maxlength="10" pattern="[0-9]+">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control form-control-lg" type="password" name="confirmpassword" placeholder="Ulangi Password" required="true" />
                </div>
                <div class="mt-3">
