...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $query->execute();
    echo '<script>alert("Kontak Berhasil Di Update")</script>';
  }
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Update Kontak </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Update Kontak</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Data Kontak Kami</h4>
                      ...
                      if ($query->rowCount() > 0) {
                        foreach ($results as $row) {               ?>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="mobnum" id="mobnum" required="true" value="<?php echo $row->MobileNumber; ?>" class="form-control" maxlength="13" pattern="[0-9]+">
                          </div>
                      <?php $cnt = $cnt + 1;
                        }
                      } ?>
