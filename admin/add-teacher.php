...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $ret = "select UserName from tblteacher where UserName=:uname || TeacID=:teacid";
        $query = $dbh->prepare($ret);
        $query->bindParam(':uname', $uname, PDO::PARAM_STR);
        $query->bindParam(':teacid', $stuid, PDO::PARAM_STR);
        $query->execute();
        ...
        if ($query->rowCount() == 0) {
            ...
            if (!in_array($extension, $allowed_extensions)) {
                ...
                $sql = "insert into tblteacher(TeacherName,TeacherEmail,Gender,DOB,teacID,ContactNumber,AltenateNumber,Address,UserName,Password,Image)values(:teacname,:teacemail,:gender,:dob,:stuid,:connum,:altconnum,:address,:uname,:password,:image)";
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="forms-sample" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="teacname" value="" class="form-control" required='true'>
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputName1">Teacher Email</label>
                                                <input type="text" name="teacemail" value="" class="form-control" required='true'>
                                            </div>
