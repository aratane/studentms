        ...
        <div class="col-md-6">
            <div class="error-template">
                <h1>
                    :) Oops!</h1>
                <h2>
                    Halaman belum tersedia sekarang</h2>
                <h1>
                    Kembali lagi nanti!</h1>
                <div>
                    <p>
                        Maaf atas ketidaknyamanan ini, tetapi halaman sedang melakukan beberapa pemeliharaan saat ini.
                        halaman akan segera dibuat!</p>
                    <p>
                        — Sanji Team</p>
                </div>
                <div class="error-actions">
                    <a href="dashboard.php" style="margin-top: 10px;" class="btn btn-info btn-lg"><span class="glyphicon glyphicon-home">
                        </span>Kembali ke Dashboard </a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
