...
?>
  ...
  <head>
    <title>Pencarian Data Guru</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Pencarian Guru </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Pencarian Guru</li>
                </ol>
              </nav>
            </div>
            <div class="row">
                  ...
                  <div class="card-body">
                    <form method="post">
                      <div class="form-group">
                        ...
                        <br><br>
                        <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Cari Menggunakan NIG">
                      </div>
                    ...
                    <div class="d-sm-flex align-items-center mb-4">
                      ...
                      ?>
                        <h4 align="center">Hasil Pencarian Dengan NIG "<?php echo $sdata; ?>"</h4>
                    </div>
                    <div class="table-responsive border rounded p-1">
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          // Code Untuk Menampilkan Halaman Navigasi
                          ...
                          $sql = "SELECT tblteacher.StuID,tblteacher.ID as sid,tblteacher.TeacherName,tblteacher.TeacherEmail,tblteacher.DateofAdmission from tblteacher where tblteacher.StuID like '$sdata%' LIMIT $offset, $no_of_records_per_page";
                          $query = $dbh->prepare($sql);
                          $query->execute();
