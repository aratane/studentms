...
?>
  ...
  <head>
    ...
    <title>Kelola Pengumuman Publik</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Kelola Pengumuman </h3>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Kelola Data Pengumuman</h4>
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> Lihat Semua Pengumuman</a>
                    </div>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div><a href="edit-public-notice-detail.php?editid=<?php echo htmlentities($row->ID); ?>"><i class="icon-eye"></i></a>
                                    || <a href="manage-public-notice.php?delid=<?php echo ($row->ID); ?>" onclick="return confirm('Apakah Kamu Yakin Ingin Menghapus ?');"> <i class="icon-trash"></i></a></div>
                                </td>
                              </tr><?php $cnt = $cnt + 1;
                                  }
                                } ?>
