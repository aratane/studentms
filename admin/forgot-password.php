...
if (isset($_POST['submit'])) {
  ...
  if ($query->rowCount() > 0) {
    ...
    echo "<script>alert('Email Atau Nomor Telepon Tidak Valid.');</script>";
  }
}
        ...
        <div class="row flex-grow">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <h6 class="font-weight-light">Masukkan Alamat Email dan Nomor Telepon Untuk Reset Password!</h6>
