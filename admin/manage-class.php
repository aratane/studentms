                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Data Pengelolaan Kelas</h4>
                      <a href="#" class="text-dark ml-auto mb-3 mb-sm-0"> Lihat Semua Kelas</a>
                    </div>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div><a href="edit-class-detail.php?editid=<?php echo htmlentities($row->ID); ?>"><i class="icon-eye"></i></a>
                                    || <a href="manage-class.php?delid=<?php echo ($row->ID); ?>" onclick="return confirm('Apakah Kamu Yakin Ingin Menghapus ?');"> <i class="icon-trash"></i></a></div>
                                </td>
                              </tr><?php $cnt = $cnt + 1;
                                  }
                                } ?>
